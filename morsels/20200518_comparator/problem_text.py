...
>>> n == target_number
True
Your Comparator object should have a default delta value of 0.0000001 (meaning numbers should be no further than that from your target number). This delta value should be customizable.
...
>>> 108 == almost_110
False
For the second bonus I'd like you to allow Comparator objects to be added and subtracted with other Comparator objects. The largest delta should be maintained when adding/subtracting:
...
For the third bonus, I'd like you to create a Comparator.default_delta context manager that allows the default Comparator delta to change within a context manager block:
