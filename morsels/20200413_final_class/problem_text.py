This week I'd like you to do something which might sound odd, but it should be informative: I'd like you to work on making classes which cannot be subclassed.
...
A TypeError should be raised, but it doesn't matter what the message in the type error is (though more helpful is better).
...
This bonus is where we start making something fun and possibly useful (though probably not directly, since this example is odd).
...
If you haven't already done so, I'd like you to create a metaclass called UnsubclassableType which will make its classes unsubclassable.
...
If you've never worked with metaclasses and class decorators in Python before, I expect you'll get stuck at some point this week.
