...
class TimerTests(unittest.TestCase):
    ...
    def test_two_timers(self):
        with Timer() as timer1:
            ...
            with Timer() as timer2:
                sleep(0.01)
            sleep(0.01)
        self.assertAlmostEqual(timer1.elapsed, 0.03, places=1)
    ...
    def test_runs_recorded(self):
        ...
        self.assertAlmostEqual(timer1.runs[0], 0.03, places=1)
    ...
    def test_split(self):
        with Timer() as timer1:
            ...
            with timer1.split() as timer4:
                sleep(0.03)
        self.assertAlmostEqual(timer1.elapsed, 0.06, places=1)
        self.assertAlmostEqual(timer2.elapsed, 0.01, places=2)
        self.assertAlmostEqual(timer3.elapsed, 0.02, places=2)
        self.assertAlmostEqual(timer4.elapsed, 0.03, places=1)
