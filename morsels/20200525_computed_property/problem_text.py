...
This week I'd like you to create a computed_property decorator that is somewhat similar to the property decorator (and the cached_property decorator you've already made).

The computed_property decorator should accept an attribute name and cache the value of the property as long as that attribute's value remains the same.
...
computing diameter
6
Just like the property decorator, computed_property instances should be unsettable and should be accessible on classes:
